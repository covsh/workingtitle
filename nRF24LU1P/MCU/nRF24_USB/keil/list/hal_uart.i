...
#line 20 "..\..\..\hal\nrf24lu1p\hal_uart.c" /0
 ...
 static uint8_t idata uart_tx[8];
 
 static uint8_t uart_rx_wp, uart_rx_rp, uart_rx_cnt;
 static uint8_t idata uart_rx[8];
